	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_1, "A SONG OF DJENT AND THALL", {"SIDEWAYS", "DOES IT", "CRAZY", "DOG GODS"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "SIDEWAYS"},
				{StageId_1_2, "DOES IT"},
				{StageId_1_3, "CRAZY"},
				{StageId_1_4, "DOG GODS"},
				{StageId_2_1, "TTFAF"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "	OG DJENTBOT MOD", false},
				{StageId_Clwn_2, "LONGESTSOLOEVER", false},
				{StageId_Clwn_2, "NEME", false},
				{StageId_Clwn_2, "WOLFYBATATA", false},
