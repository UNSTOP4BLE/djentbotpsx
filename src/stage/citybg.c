...
//Henchmen functions
void citybg_Henchmen_SetFrame(void *user, u8 frame)
{
	Back_citybg *this = (Back_citybg*)user;
...
void citybg_Henchmen_Draw(Back_citybg *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_citybg_DrawFG(StageBack *back)
{
	Back_citybg *this = (Back_citybg*)back;
...
void Back_citybg_DrawMD(StageBack *back)
{
	Back_citybg *this = (Back_citybg*)back;
...
void Back_citybg_DrawBG(StageBack *back)
{
	Back_citybg *this = (Back_citybg*)back;
	...
	Animatable_Animate(&this->hench_animatable, (void*)this, citybg_Henchmen_SetFrame);
	
	citybg_Henchmen_Draw(this, FIXED_DEC(-50,1) - fx, FIXED_DEC(30,1) - fy);
	citybg_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	citybg_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	citybg_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
void Back_citybg_Free(StageBack *back)
{
	Back_citybg *this = (Back_citybg*)back;
...
StageBack *Back_citybg_New(void)
{
	//Allocate background structure
	Back_citybg *this = (Back_citybg*)Mem_Alloc(sizeof(Back_citybg));
	if (this == NULL)
		return NULL;
	
	//Set background functions
	this->back.draw_fg = Back_citybg_DrawFG;
	this->back.draw_md = Back_citybg_DrawMD;
	this->back.draw_bg = Back_citybg_DrawBG;
	this->back.free = Back_citybg_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\CITYBG\\BACK.ARC;1");
	...
	this->arc_hench = IO_Read("\\CITYBG\\HENCH.ARC;1");
