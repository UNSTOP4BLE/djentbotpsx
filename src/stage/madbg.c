...
//Henchmen functions
void madbg_Henchmen_SetFrame(void *user, u8 frame)
{
	Back_madbg *this = (Back_madbg*)user;
...
void madbg_Henchmen_Draw(Back_madbg *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_madbg_DrawFG(StageBack *back)
{
	Back_madbg *this = (Back_madbg*)back;
...
void Back_madbg_DrawMD(StageBack *back)
{
	Back_madbg *this = (Back_madbg*)back;
...
void Back_madbg_DrawBG(StageBack *back)
{
	Back_madbg *this = (Back_madbg*)back;
	...
	Animatable_Animate(&this->hench_animatable, (void*)this, madbg_Henchmen_SetFrame);
	
	madbg_Henchmen_Draw(this, FIXED_DEC(-50,1) - fx, FIXED_DEC(30,1) - fy);
	madbg_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	madbg_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	madbg_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
void Back_madbg_Free(StageBack *back)
{
	Back_madbg *this = (Back_madbg*)back;
...
StageBack *Back_madbg_New(void)
{
	//Allocate background structure
	Back_madbg *this = (Back_madbg*)Mem_Alloc(sizeof(Back_madbg));
	if (this == NULL)
		return NULL;
	
	//Set background functions
	this->back.draw_fg = Back_madbg_DrawFG;
	this->back.draw_md = Back_madbg_DrawMD;
	this->back.draw_bg = Back_madbg_DrawBG;
	this->back.free = Back_madbg_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\MADBG\\BACK.ARC;1");
	...
	this->arc_hench = IO_Read("\\MADBG\\HENCH.ARC;1");
