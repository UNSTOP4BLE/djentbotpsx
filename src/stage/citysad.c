...
//Henchmen functions
void citysad_Henchmen_SetFrame(void *user, u8 frame)
{
	Back_citysad *this = (Back_citysad*)user;
...
void citysad_Henchmen_Draw(Back_citysad *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_citysad_DrawFG(StageBack *back)
{
	Back_citysad *this = (Back_citysad*)back;
...
void Back_citysad_DrawMD(StageBack *back)
{
	Back_citysad *this = (Back_citysad*)back;
...
void Back_citysad_DrawBG(StageBack *back)
{
	Back_citysad *this = (Back_citysad*)back;
	...
	Animatable_Animate(&this->hench_animatable, (void*)this, citysad_Henchmen_SetFrame);
	
	citysad_Henchmen_Draw(this, FIXED_DEC(-50,1) - fx, FIXED_DEC(30,1) - fy);
	citysad_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	citysad_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	citysad_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
void Back_citysad_Free(StageBack *back)
{
	Back_citysad *this = (Back_citysad*)back;
...
StageBack *Back_citysad_New(void)
{
	//Allocate background structure
	Back_citysad *this = (Back_citysad*)Mem_Alloc(sizeof(Back_citysad));
	if (this == NULL)
		return NULL;
	
	//Set background functions
	this->back.draw_fg = Back_citysad_DrawFG;
	this->back.draw_md = Back_citysad_DrawMD;
	this->back.draw_bg = Back_citysad_DrawBG;
	this->back.free = Back_citysad_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\CITYSAD\\BACK.ARC;1");
	...
	this->arc_hench = IO_Read("\\CITYSAD\\HENCH.ARC;1");
